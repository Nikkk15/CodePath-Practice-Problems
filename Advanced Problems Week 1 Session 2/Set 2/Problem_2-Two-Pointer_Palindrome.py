...
# (also called a pointer in this context) to track different indices
# or places in a list or string, then moves the pointers to point at
# new indices based on certain conditions. In the most common variation
# of the two-pointer approach, we initialize one variable to point at the
# beginning of a list and a second variable/pointer to point at the end of list.
...
s = "swoadsidhwiiwhdisdaows"
print(is_palindrome(s))

s = "swoadsidhwidsiwhdisdaows"
print(is_palindrome(s))
